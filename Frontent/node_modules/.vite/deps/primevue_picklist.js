import {
  script as script8,
  script2 as script9
} from "./chunk-Y5LC3HCY.js";
import {
  script as script3,
  script2 as script6,
  script3 as script7
} from "./chunk-OCQRD7NC.js";
import {
  script as script5
} from "./chunk-MDZLZXZQ.js";
import {
  script as script4
} from "./chunk-IG3DJUSB.js";
import {
  script as script2
} from "./chunk-OLLOHZF5.js";
import {
  script
...
`;
  ...
  components: {
    ...
    AngleDoubleDownIcon: script8,
    AngleDoubleUpIcon: script9
  },
  directives: {
    ripple: Ripple
  }
      ...
      createVNode(_component_PLButton, mergeProps({
        ...
        icon: withCtx(() => [
          renderSlot(_ctx.$slots, "movetotargeticon", { viewChanged: $data.viewChanged }, () => [
            (openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? "AngleDownIcon" : "AngleRightIcon")))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
      createVNode(_component_PLButton, mergeProps({
        ...
        icon: withCtx(() => [
          renderSlot(_ctx.$slots, "movealltotargeticon", { viewChanged: $data.viewChanged }, () => [
            (openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? "AngleDoubleDownIcon" : "AngleDoubleRightIcon")))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
      createVNode(_component_PLButton, mergeProps({
        ...
        icon: withCtx(() => [
          renderSlot(_ctx.$slots, "movetosourceicon", { viewChanged: $data.viewChanged }, () => [
            (openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? "AngleUpIcon" : "AngleLeftIcon")))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
      createVNode(_component_PLButton, mergeProps({
        ...
        icon: withCtx(() => [
          renderSlot(_ctx.$slots, "movealltosourceicon", { viewChanged: $data.viewChanged }, () => [
            (openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? "AngleDoubleUpIcon" : "AngleDoubleLeftIcon")))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
