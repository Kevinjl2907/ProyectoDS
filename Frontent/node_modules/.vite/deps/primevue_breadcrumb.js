      ...
      $props.item.to ? (openBlock(), createBlock(_component_router_link, {
        ...
        default: withCtx(({ navigate, href, isActive, isExactActive }) => [
          createBaseVNode("a", {
            ...
            }, null, 8, ["item"])) : $props.item.icon ? (openBlock(), createElementBlock("span", {
              key: 1,
        ...
        $props.item.label ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString($options.label()), 1)) : createCommentVNode("", true)
      ], 10, _hoisted_3$1))
  ...
  return openBlock(), createElementBlock("nav", _hoisted_1, [
    createBaseVNode("ol", _hoisted_2, [
      $props.home ? (openBlock(), createBlock(_component_BreadcrumbItem, {
        ...
        exact: $props.exact
      }, null, 8, ["item", "templates", "exact"])) : createCommentVNode("", true),
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.model, (item, i) => {
        return openBlock(), createElementBlock(Fragment, {
          key: item.label
        }, [
          $props.home || i !== 0 ? (openBlock(), createElementBlock("li", _hoisted_3, [
            renderSlot(_ctx.$slots, "separator", {}, () => [
              createVNode(_component_ChevronRightIcon, { "aria-hidden": "true" })
            ])
