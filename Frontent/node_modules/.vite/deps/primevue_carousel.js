      ...
      createBaseVNode("div", {
        ...
        $props.showNavigators ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
          ...
          renderSlot(_ctx.$slots, "previousicon", {}, () => [
            (openBlock(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronUpIcon" : "ChevronLeftIcon"), { class: "p-carousel-next-icon" }))
          ])
        ], 16, _hoisted_3)), [
          [_directive_ripple]
        ]) : createCommentVNode("", true),
        ...
        $props.showNavigators ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
          ...
          renderSlot(_ctx.$slots, "nexticon", {}, () => [
            (openBlock(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronDownIcon" : "ChevronRightIcon"), { class: "p-carousel-prev-icon" }))
          ])
        ], 16, _hoisted_5)), [
          [_directive_ripple]
        ]) : createCommentVNode("", true)
