...
function w() {
  ...
  for (t.sort(f); n2 = t.shift(); )
    n2.__d && (l3 = t.length, i3 = void 0, r3 = void 0, e3 = (o2 = (u3 = n2).__v).__e, (c3 = u3.__P) && (i3 = [], (r3 = h2({}, o2)).__v = o2.__v + 1, L(c3, o2, r3, u3.__n, void 0 !== c3.ownerSVGElement, null != o2.__h ? [e3] : null, i3, null == e3 ? b(o2) : e3, o2.__h), M(i3, o2), o2.__e != e3 && g(o2)), t.length > l3 && t.sort(f));
  w.__r = 0;
}
function x(n2, l3, u3, i3, t3, r3, o2, f3, e3, a3) {
  var h4, v3, y3, d2, k3, g4, m3, w4 = i3 && i3.__k || s, x3 = w4.length;
  for (u3.__k = [], h4 = 0; h4 < l3.length; h4++)
    if (null != (d2 = u3.__k[h4] = null == (d2 = l3[h4]) || "boolean" == typeof d2 || "function" == typeof d2 ? null : "string" == typeof d2 || "number" == typeof d2 || "bigint" == typeof d2 ? p(null, d2, null, null, d2) : Array.isArray(d2) ? p(_, { children: d2 }, null, null, null) : d2.__b > 0 ? p(d2.type, d2.props, d2.key, d2.ref ? d2.ref : null, d2.__v) : d2)) {
      if (d2.__ = u3, d2.__b = u3.__b + 1, null === (y3 = w4[h4]) || y3 && d2.key == y3.key && d2.type === y3.type)
        w4[h4] = void 0;
      else
        for (v3 = 0; v3 < x3; v3++) {
  ...
  for (u3.__e = g4, h4 = x3; h4--; )
    null != w4[h4] && ("function" == typeof u3.type && null != w4[h4].__e && w4[h4].__e == u3.__d && (u3.__d = $(i3).nextSibling), S(w4[h4], w4[h4]));
  if (m3)
...
function N(l3, u3, i3, t3, r3, o2, f3, e3) {
  var s3, a3, h4, y3 = i3.props, p3 = u3.props, d2 = u3.type, _3 = 0;
  ...
  if (null === d2)
    ...
    if (o2 = o2 && n.call(l3.childNodes), a3 = (y3 = i3.props || c).dangerouslySetInnerHTML, h4 = p3.dangerouslySetInnerHTML, !e3) {
      if (null != o2)
        for (y3 = {}, _3 = 0; _3 < l3.attributes.length; _3++)
          y3[l3.attributes[_3].name] = l3.attributes[_3].value;
      (h4 || a3) && (h4 && (a3 && h4.__html == a3.__html || h4.__html === l3.innerHTML) || (l3.innerHTML = h4 && h4.__html || ""));
    }
    if (H(l3, p3, y3, r3, e3), h4)
      u3.__k = [];
...
n = s.slice, l = { __e: function(n2, l3, u3, i3) {
  ...
  var u3;
  u3 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = h2({}, this.state), "function" == typeof n2 && (n2 = n2(h2({}, u3), this.props)), n2 && h2(u3, n2), null != n2 && this.__v && (l3 && this._sb.push(l3), m(this));
