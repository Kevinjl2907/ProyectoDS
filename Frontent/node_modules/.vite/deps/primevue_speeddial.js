        ...
        createVNode(_component_SDButton, {
          ...
          icon: withCtx(() => [
            renderSlot(_ctx.$slots, "icon", { visible: $data.d_visible }, () => [
              $data.d_visible && !!$props.hideIcon ? (openBlock(), createBlock(resolveDynamicComponent($props.hideIcon ? "span" : "PlusIcon"), {
                key: 0,
                class: normalizeClass($props.hideIcon)
              }, null, 8, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.showIcon ? "span" : "PlusIcon"), {
                key: 1,
