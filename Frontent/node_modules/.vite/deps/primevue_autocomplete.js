...
var _hoisted_6 = ["id", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant"];
var _hoisted_7 = {
  role: "status",
  "aria-live": "polite",
...
var _hoisted_8 = ["id"];
var _hoisted_9 = ["id"];
var _hoisted_10 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove"];
var _hoisted_11 = {
  key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $data.searching ? renderSlot(_ctx.$slots, "loadingicon", { key: 2 }, () => [
      $props.loadingIcon ? (openBlock(), createElementBlock("i", {
        key: 0,
        class: normalizeClass(["p-autocomplete-loader pi-spin", $props.loadingIcon]),
        "aria-hidden": "true"
      ...
      icon: withCtx(() => [
        renderSlot(_ctx.$slots, "dropdownicon", {}, () => [
          (openBlock(), createBlock(resolveDynamicComponent($props.dropdownIcon ? "span" : "ChevronDownIcon"), {
            class: normalizeClass($props.dropdownIcon)
          }, null, 8, ["class"]))
        ])
      ]),
      _: 3
    }, 8, ["class", "disabled", "onClick"])) : createCommentVNode("", true),
    createBaseVNode("span", _hoisted_7, toDisplayString($options.searchResultMessageText), 1),
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
                  ...
                  createBaseVNode("ul", {
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(items, (option, i) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        ], 12, _hoisted_9)) : withDirectives((openBlock(), createElementBlock("li", {
                          key: 1,
                          id: $data.id + "_" + $options.getOptionIndex(i, getItemOptions),
                          style: normalizeStyle({ height: itemSize ? itemSize + "px" : void 0 }),
                    ...
                    !items || items && items.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_11, [
              ...
              createBaseVNode("span", _hoisted_12, toDisplayString($options.selectedMessageText), 1)
