        ...
        $props.item.to && !$options.disabled() ? (openBlock(), createBlock(_component_router_link, {
          ...
          default: withCtx(({ navigate, href, isActive, isExactActive }) => [
            withDirectives((openBlock(), createElementBlock("a", {
              ...
              }, null, 8, ["item", "class"])) : $props.item.icon ? (openBlock(), createElementBlock("span", {
                key: 1,
                class: normalizeClass($options.iconClass)
                  ...
                  item.items && $options.visible(item) && !item.separator ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(item.items, (child, j) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        }, null, 8, ["id", "item", "templates", "exact", "focusedOptionId", "onItemClick"])) : $options.visible(child) && child.separator ? (openBlock(), createElementBlock("li", {
                          key: "separator" + i + j,
