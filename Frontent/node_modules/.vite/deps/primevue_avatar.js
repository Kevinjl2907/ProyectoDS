...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    !_ctx.$slots.default ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
      $props.label ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString($props.label), 1)) : _ctx.$slots.icon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.icon), {
        key: 1,
        class: "p-avatar-icon"
      })) : $props.icon ? (openBlock(), createElementBlock("span", {
        key: 2,
        class: normalizeClass(["p-avatar-icon", $props.icon])
