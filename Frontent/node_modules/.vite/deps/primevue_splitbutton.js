        ...
        icon: withCtx((slotProps) => [
          renderSlot(_ctx.$slots, "icon", {}, () => [
            createBaseVNode("span", {
              class: normalizeClass([$props.icon, slotProps.class])
            }, null, 2)
          ])
        ]),
        _: 3
    ...
    createVNode(_component_PVSButton, mergeProps({
      ...
      icon: withCtx((slotProps) => [
        renderSlot(_ctx.$slots, "menubuttonicon", {}, () => [
          (openBlock(), createBlock(resolveDynamicComponent($props.menuButtonIcon ? "span" : "ChevronDownIcon"), {
            class: normalizeClass([$props.menuButtonIcon, slotProps.class])
          }, null, 8, ["class"]))
        ])
      ]),
      _: 3
    }, 16, ["disabled", "aria-expanded", "aria-controls", "onClick", "onKeydown"]),
...
script4.__scopeId = "data-v-5a8b8d41";
export {
  script4 as default
};
