              ...
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  withDirectives((openBlock(), createElementBlock("a", {
                    ...
                    }, null, 8, ["item", "class"])) : $options.getItemProp(processedItem, "icon") ? (openBlock(), createElementBlock("span", {
                      key: 1,
                      class: normalizeClass($options.getItemIconClass(processedItem))
                ...
                $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  }, null, 8, ["active"])) : (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(processedItem) ? "ChevronDownIcon" : "ChevronRightIcon"), {
                    key: 1,
                    class: "p-submenu-icon"
                  }))
          ...
          createVNode(Transition, { name: "p-toggleable-content" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode("div", _hoisted_8$1, [
                ...
                }, null, 8, ["id", "panelId", "focusedItemId", "items", "level", "templates", "activeItemPath", "exact", "onItemToggle"])) : createCommentVNode("", true)
              ], 512), [
                ...
                $options.getItemProp(item, "to") && !$options.isItemDisabled(item) ? (openBlock(), createBlock(_component_router_link, {
                  ...
                  default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                    createBaseVNode("a", {
                      ...
                      _ctx.$slots.headericon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.headericon), {
                        key: 0,
                        item,
                        class: normalizeClass($options.getHeaderIconClass(item))
                      }, null, 8, ["item", "class"])) : $options.getItemProp(item, "icon") ? (openBlock(), createElementBlock("span", {
                        key: 1,
                        class: normalizeClass($options.getHeaderIconClass(item))
                      }, null, 2)) : createCommentVNode("", true),
                  ...
                  $options.getItemProp(item, "items") ? renderSlot(_ctx.$slots, "submenuicon", {
                    key: 0,
