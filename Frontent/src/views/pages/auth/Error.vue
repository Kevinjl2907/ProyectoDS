  ...
  <AppMenu v-show="false"/>
    ...
    <div class="px-5 min-h-screen flex justify-content-center align-items-center">
        <div class="z-1 text-center">
            ...
            <p class="line-height-3 mt-0 mb-5 text-700 text-xl font-medium">Correo o Contraseña Incorrecto.</p>
            <Button class="p-button-danger font-medium p-button-raised" @click="navigateToDashboard"> Volver </Button>
        </div>
    </div>
    <AppConfig simple />
</template>
