...
export default {
    ...
    data() {
        return {
            // URL's
            url: 'http://127.0.0.1:8000/CrearPlanTrabajo/',
    ...
    methods: {
      ...
      initFilters() {
        ...
        async deleteItem() {
            ...
            if (this.selectedActividad == null) {
                ...
                if (this.borrarActividad) {
                    ...
                    var response = await fetch('http://127.0.0.1:8000/BorrarActividad/', request);
        ...
        async validacionActividad() {
            ...
            var response = await fetch('http://127.0.0.1:8000/AgregarActividad/', request);
            response = await response.json();
        ...
        async getTipoActividad() {
            ...
            var response = await fetch('http://127.0.0.1:8000/ObtenerTipoAct/', request);
            var myJson = await response.json();
            return myJson.tipos
        },
        ...
        async parseSelected() {
            ...
            console.log(this.fileAfiche);
            var response = await fetch('http://127.0.0.1:8000/ModificarActividad/', request);
            response = await response.json();
            console.log(response);
