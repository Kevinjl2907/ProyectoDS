...
export default {
  ...
  methods: {
    ...
    async modEstudiante() {
      ...
      var response = await fetch("https://main.d2anrgvy7s2j70.amplifyapp.com/ModificarEstudiante/", request)
    ...
    async cargarExcel(event) {
      ...
      var response = await fetch("https://main.d2anrgvy7s2j70.amplifyapp.com/CargarExcel/", request)
      response = await response.json()
