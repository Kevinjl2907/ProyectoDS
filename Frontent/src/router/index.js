    ...
    routes: [
            ...
            children: [
                {
                    ...
                    name: 'Equipo Guía',
                    meta: {
                        breadcrumb: ['Equipo Guía']
                    },
                    component: () => import('@/views/profeGuia/EquipoGuia.vue')
                },
                {
                    path: '/estudiantes',
                    name: 'Estudiantes',
                    ...
                    component: () => import('@/views/profeGuia/Estudiantes.vue')
                },
                {
                    ...
                    component: () => import('@/views/profeGuia/ModificarEstudiante.vue')
                },
                {
                    path: '/exportarExcel',
                    name: 'Exportar Excel',
                    meta: {
                        breadcrumb: ['Generar Excel']
                    },
                    component: () => import('@/views/profeGuia/ExportarExcel.vue')
                },
                {
                    path: '/comentarios',
                    name: 'Comentarios',
                    ...
                    component: () => import('@/views/profeGuia/comentarios/Index.vue')
                },
                {
                    path: '/planTrabajo',
                    name: 'Plan de Trabajo Asistente',
                    meta: {
                        breadcrumb: ['Plan de Trabajo']
                    },
                    component: () => import('@/views/profeGuia/Plan.vue')
                },
                {
                    path: '/planTrabajoProfe',
                    name: 'Plan de Trabajo',
                    meta: {
                        breadcrumb: ['Plan de Trabajo']
                    },
                    component: () => import('@/views/profeGuia/PlanProfes.vue')
                },
                {
                    path: '/landing',
                    name: 'Inicio',
                    ...
                    component: () => import('@/views/comunes/Landing.vue')
                },
                {
                    path: '/admin-planTrabajo',
                    name: 'Administrar Plan de Trabajo',
                    meta: {
                        breadcrumb: ['Administrar Plan de Trabajo']
                    },
                    component: () => import('@/views/profeGuia/AdminPlanTrabajo.vue')
                },
                {
                    path: '/admin-actividades',
                    name: 'Administrar Actividades',
                    meta: {
                        breadcrumb: ['Administrar Actividades']
                    },
                    component: () => import('@/views/profeGuia/AdminActividades.vue')
                },
                /*
                {
                    path: '/auth/access',
        ...
        */
        ...
        },
        {
            ...
            name: 'forgotpassword',
            component: () => import('@/views/pages/auth/forpass.vue')
        }
        */
        {
